...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',Department='$department',sem='$sem',Section='$section' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="col-sm-4">
<input  type="text" name="Department" required="required" class="form-control" value="<?php echo htmlentities($row['Department']);?>" >
</div>
</div>
...
<div class="col-sm-4">
<input name="sem" type="text" required="required" class="form-control" value="<?php echo htmlentities($row['sem']);?>">
</div>
