...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into users(fullName,usn,userEmail,password,contactNo,status) values('$fullname','$USN','$email','$password','$contactno','$status')");
...
error:function (){}
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
	<h3 align="center" style="color:#800000"><a href="../index.html" style="color:#800000">Student Grievence System</a></h3>
	<hr />
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
					<br>
					<input type="text" class="form-control" placeholder="USN" name="USN" required="required" autofocus>
					<br>
    ...
    <script>
        $.backstretch("assets/img/login-bg.bmp", {speed: 500});
    </script>
