...
<tr>
											...
											<td colspan="5"> <?php echo htmlentities($row['name']);?></td>
										</tr>
										<tr>
											<td><b>Reg Date</b></td>
...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/GRIEVENCE SYSTEM/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/GRIEVENCE SYSTEM/admin/userprofile.php?uid=<?php echo htmlentities($row['userid']);?>');" title="Update order">
